...
drug_dataset = drug_dataset.filter(lambda x: x["condition"] not in not_train_conditions)
...
condition_code = {}
code = 0
for condition in conditions_train_keys:
...
drug_dataset_train = drug_dataset["train"]
print(f'drug_dataset_train: {drug_dataset_train}')
print(f'drug_dataset_train.features: {drug_dataset_train.features}')
print(f'drug_dataset_train[0]: {drug_dataset_train[0]}')

"""
for dataset in drug_dataset_train:
    print(dataset['condition'])
"""

# "basic_sentiment holds values [-1,0,1]
condition_labels = ClassLabel(num_classes = len(condition_code),names=list(condition_code.keys()))
drug_dataset = drug_dataset.cast_column("condition", condition_labels)
...
code = drug_dataset_train[0]['condition']
condition_names = list(condition_code.keys())
print(condition_names[code])

"""
for dataset in drug_dataset_train:
    print(condition_names[dataset['condition']])
"""
